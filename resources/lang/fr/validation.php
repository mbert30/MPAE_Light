...
// Créer le fichier : resources/lang/fr/validation.php
...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'adresse.ligne1' => [
            'unique' => 'Cette adresse est déjà enregistrée dans le système.',
        ],
        'adresse.ville' => [
            'unique' => 'Cette ville est déjà enregistrée pour cette adresse.',
        ],
    ],
